...
Procedimiento vigente con responsables, límites probados y comandos exactos: [operational-runbook.md](operational-runbook.md). Node 24, contrato clásico y schemas remotos ya están acreditados. Los deployments Production y sus smokes siguen pendientes de autorización.

No está autorizado aplicar este plan en esta auditoría. El candidato validado es 835fdc08, con código idéntico a 6287c9ae. La investigación de B1–B5 quedó resuelta; ejecutar sus acciones remotas y aceptación requiere autorización según [README](README.md).

## Orden exacto

1. **Ventana del panel.** Avisar y coordinar la pausa de edición/publicación y administración de teléfonos; cerrar pestañas antiguas y exigir recarga posterior. Landings públicas, recepción y colas deben seguir operando; no prometer cero interrupción de DB por locks. No existe un bloqueo técnico de mantenimiento implementado. Si se exige cero interrupción administrativa, hace falta otro release puente autorizado.
2. **Configuración y artefactos.** Revalidar origin/main, alias Vercel, ledger 268, hashes/ACL/owners y esquemas. Configurar REVALIDATION_ENV=production sólo en Vercel Production; conservar claves existentes. Crear allí los deployments sin dominios del candidato y ad436ff1, cuyos builds Node 24 locales ya pasaron. No cambiar Preview/staging, promover ni hacer push a main que dispare publicación automática.
