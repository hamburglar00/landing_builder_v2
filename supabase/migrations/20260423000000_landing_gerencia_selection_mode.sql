...
comment on column public.landings.gerencia_selection_mode is
  'Modo de selecci�n de gerencias: weighted_random (aleatorio por weight) o fair (equitativo).';
...
comment on function public.get_phone_for_landing(text) is
  'Selecciona tel�fono para landing con selecci�n de gerencia weighted_random (por weight) o fair (por criterio global de landing), m�s selecci�n de tel�fono random/fair por gerencia.';
