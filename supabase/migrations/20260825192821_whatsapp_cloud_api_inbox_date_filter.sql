...
revoke all on function public.get_whatsapp_cloud_api_inbox_threads_page(integer, integer, text, text, boolean, timestamptz, timestamptz)
  from public, anon;
grant execute on function public.get_whatsapp_cloud_api_inbox_threads_page(integer, integer, text, text, boolean, timestamptz, timestamptz)
  to authenticated;
...
comment on function public.mark_whatsapp_cloud_api_threads_read(text, text, timestamptz, timestamptz) is
  'Marca como leidos los threads WCA visibles para moneda, etiqueta y rango de actividad.';

revoke all on function public.mark_whatsapp_cloud_api_threads_read(text, text, timestamptz, timestamptz)
  from public, anon;
grant execute on function public.mark_whatsapp_cloud_api_threads_read(text, text, timestamptz, timestamptz)
  to authenticated;
