alter table public.whatsapp_cloud_api_configs
  add column if not exists enrich_business_messaging_user_data boolean not null default false;

comment on column public.whatsapp_cloud_api_configs.enrich_business_messaging_user_data is
  'Si true, LeadSubmitted/Purchase de WhatsApp Cloud API agregan PII hasheada disponible al user_data de Business Messaging. Default false para respetar el payload minimo documentado.';
