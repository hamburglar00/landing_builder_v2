alter table public.whatsapp_cloud_api_retarget_messages
  drop constraint if exists whatsapp_cloud_api_retarget_messages_contact_id_retarget_kind_key;

create unique index if not exists whatsapp_cloud_api_retarget_contact_once_uidx
  on public.whatsapp_cloud_api_retarget_messages (contact_id);
