...
comment on column public.whatsapp_cloud_api_configs.retargeting_enabled is
  'Activa/desactiva el retargeting automatico de WhatsApp Cloud API para contactos nuevo/contacto dentro de la ventana segura.';
...
comment on function public.claim_whatsapp_cloud_api_retarget_candidates(integer, integer, integer) is
  'Reclama candidatos de retarget WCA con inbound reciente, sin lead/purchase, sin retarget previo y con retargeting habilitado en la config.';
