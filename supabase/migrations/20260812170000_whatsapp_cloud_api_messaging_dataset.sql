...
comment on column public.whatsapp_cloud_api_configs.meta_messaging_dataset_id is
  'Dataset ID linked to the WhatsApp Business Account for Conversions API for Business Messaging.';
