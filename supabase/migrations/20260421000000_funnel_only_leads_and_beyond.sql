-- El funnel solo incluye contactos que alcanzaron lead (enviaron mensaje).
-- Los contact-only (solo hicieron clic en CTA) no tienen incumbencia en el funnel.
...
having bool_or(c.lead_event_id <> '') = true;

comment on view public.funnel_contacts is 'Solo leads y beyond. Contact-only no aparecen en el funnel.';
