-- Revertir: funnel_contacts vuelve a agrupar solo por phone.
-- Los contactos únicos se cuentan por estado en el frontend (conversions), no por funnel_contacts.
...
comment on view public.funnel_contacts is 'Vista agregada por teléfono para funnel (leads/purchases). Contactos únicos se cuentan por estado en frontend.';
