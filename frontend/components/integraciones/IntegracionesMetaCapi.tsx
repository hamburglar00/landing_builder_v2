          ...
          <section className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-950/30 px-3 py-2 sm:col-span-2">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className="text-xs font-medium text-zinc-300">Enviar eventos a Meta CAPI</p>
                    <p className="mt-0.5 text-[11px] text-zinc-500">
                      Controla si Chatrace envia Contact, Lead y Purchase por Conversions API.
                    </p>
                  </div>
                  <button
                    type="button"
                    role="switch"
                    aria-checked={chatraceSendMetaCapiEvents}
                    onClick={() => setChatraceSendMetaCapiEvents((v) => !v)}
                    className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full border transition ${
                      chatraceSendMetaCapiEvents
                        ? "border-emerald-500/60 bg-emerald-500/30"
                        : "border-zinc-700 bg-zinc-800"
                  ...
                  >
                    <span
                      className={`inline-block h-5 w-5 transform rounded-full bg-white transition ${
                        chatraceSendMetaCapiEvents ? "translate-x-5" : "translate-x-0.5"
                      }`}
                    />
                  </button>
                </div>
