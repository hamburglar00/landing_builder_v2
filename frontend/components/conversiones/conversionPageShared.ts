...
export const ALL_COLUMNS = [
  "phone","email","form_fn","form_ln","form_email","form_phone","fn","ln","ct","st","zip","country","fbp","fbc","from_meta_ads","meta_pixel_id","pixel_id","dataset_id","pixel_attribution_source","pixel_attribution_conversion_id","source_platform","ctwa_clid","atrio_id","atrio_client_id","atrio_slug","atrio_players_id",
  ...
  "lead_bot_phone","lead_player_username","lead_agency_id","lead_gerencia_label","lead_incoming_promo_code","lead_atrio_id","lead_atrio_players_id","lead_attribution_status","lead_attribution_conversion_id",
  "registration_event_id","registration_event_time","registration_player_username","registration_payload_raw",
  "registration_bot_phone","registration_agency_id","registration_gerencia_label","registration_incoming_promo_code","registration_atrio_id","registration_atrio_players_id","registration_attribution_status","registration_attribution_conversion_id",
  "purchase_bot_phone","purchase_player_username","purchase_agency_id","purchase_gerencia_label","purchase_incoming_promo_code","purchase_atrio_id","purchase_atrio_players_id","purchase_attribution_status","purchase_attribution_conversion_id",
...
export const FRIENDLY_HIDDEN_COLUMNS = new Set<ConversionColumnKey>([
  ...
  "registration_atrio_id",
  "registration_atrio_players_id",
...
const FRIENDLY_COLUMN_LABELS: Record<ConversionColumnKey, string> = {
  ...
  atrio_id: "ID de Atrio",
  atrio_client_id: "Cliente Atrio interno",
  atrio_slug: "Slug de Atrio",
  atrio_players_id: "Jugador Atrio",
  ...
  lead_atrio_id: "ID de Atrio en Lead",
  lead_atrio_players_id: "Jugador Atrio en Lead",
  ...
  purchase_atrio_id: "ID de Atrio en compra",
  purchase_atrio_players_id: "Jugador Atrio en compra",
  ...
  registration_atrio_id: "ID de Atrio en registro",
  registration_atrio_players_id: "Jugador Atrio en registro",
...
export const COLUMN_NOTES: Partial<Record<ConversionColumnKey | "id", string>> = {
  ...
  atrio_slug: "Slug publico de Atrio usado por la landing para redirigir al webchat.",
  atrio_players_id: "Identificador del jugador/cliente dentro de Atrio, si Atrio lo informa.",
  ...
  lead_atrio_id: "atrio_id recibido con action=LEAD.",
  lead_atrio_players_id: "players_id recibido con action=LEAD desde Atrio.",
  ...
  purchase_atrio_id: "atrio_id recibido con action=PURCHASE.",
  purchase_atrio_players_id: "players_id recibido con action=PURCHASE desde Atrio.",
  ...
  registration_atrio_id: "atrio_id recibido con action=COMPLETEREGISTRATION.",
  registration_atrio_players_id: "players_id recibido con action=COMPLETEREGISTRATION desde Atrio.",
