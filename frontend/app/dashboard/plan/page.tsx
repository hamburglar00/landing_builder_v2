  ...
  return (
    <div className="space-y-6">
      ...
      <section className={`rounded-2xl border p-5 ${currentPlan.colorClass}`}>
        <h2 className="text-base font-semibold text-zinc-50">Plan actual: {currentPlan.title}</h2>
        {loading ? (
          ...
          <div className="mt-3 grid gap-2 text-sm text-zinc-200 sm:grid-cols-2">
            <p>
              ...
              {sub?.max_landings ?? 2} landings · {sub?.max_phones ?? 5} teléfonos
            </p>
            <p>
            ...
            <p>
              ...
              {sub?.expires_at ? new Date(sub.expires_at).toLocaleDateString() : "Sin vencimiento"}
            </p>
          </div>
        )}
      </section>
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-zinc-200">Comparación de planes</h2>
