...
export default function DashboardLandingEditarPage() {
  ...
  return (
    <div className="lg:flex lg:gap-8 lg:max-h-[calc(100vh-7rem)] lg:items-start">
      {/* Columna izquierda: scroll independiente en desktop */}
        ...
        <section className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          ...
          {gerencias.length === 0 ? (
            <p className="text-sm text-zinc-500">
              No tienes gerencias. <Link href="/dashboard/gerencias" className="text-zinc-300 underline hover:text-zinc-100">Crear gerencias</Link>
            </p>
          ) : (
      ...
      {/* Columna derecha: preview fija en desktop, siempre visible */}
