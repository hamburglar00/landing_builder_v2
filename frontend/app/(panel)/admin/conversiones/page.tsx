...
export default function AdminConversionesPage() {
  ...
  useEffect(() => {
    const validValues = statsGerenciaFilter.filter((filter) => statsGerenciaOptions.includes(filter));
  ...
  const pdfTableColumns = useMemo(
    () => [
      "timestamp" as ColKey,
      ...columnsForTableView(ALL_COLUMNS, "friendly").filter(
  ...
  const selectedPerformanceGerenciaLabels = useMemo(
    ...
    [performanceLandingOptions, statsGerenciaFilter, effectiveStatsLandingFilter],
  );
  useEffect(() => {
    setTablePage(1);
  }, [tableSearch, dateRange, effectiveStatsLandingFilter, statsPixelFilter, statsGerenciaFilter, statsTelefonoFilter, statsFromMetaAdsFilter, statsSourcePlatformFilter, statsSexoFilter, statsCampaignFilter, statsDeviceFilter, demoMode, currencyScope]);
  useEffect(() => {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      {(tab === "funnel" || tab === "seguimiento" || tab === "tabla" || tab === "estadisticas" || tab === "desempeno") && (
        <div className="flex flex-col gap-2 pt-1 sm:flex-row sm:items-center sm:justify-between">
          <div className="grid grid-cols-2 gap-2 sm:flex sm:items-center">
            ...
            {(tab === "funnel" || tab === "tabla" || tab === "estadisticas" || tab === "desempeno") && (
              <button
                type="button"
