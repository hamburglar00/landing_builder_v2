...
export default function AdminLandingEditarPage() {
  ...
  return (
    <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start lg:gap-6">
      ...
      {landing.landingType !== "external" && <aside className="sticky top-20 hidden max-h-[calc(100dvh-6rem)] w-[360px] overflow-y-auto rounded-2xl border border-[var(--color-border)] bg-[rgba(11,15,21,0.72)] p-3 shadow-[var(--shadow-card)] lg:block">
